...
- **Previous file in reading order:** [Proximity lower bounds and transformations](../proximity/48_proximity-lower-bounds.md)
- **Next file in reading order:** [Closest pair: 2D merge step](../proximity/50_closest-pair-2d-merge.md)
