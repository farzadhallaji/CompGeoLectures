...
- **Previous file in reading order:** [Gift wrapping in higher dimensions: supporting hyperplanes, initialization, candidates, and analysis](../convex-hulls/46_higher-dimensional-hull-init-analysis.md)
- **Next file in reading order:** [Proximity lower bounds and transformations](../proximity/48_proximity-lower-bounds.md)
