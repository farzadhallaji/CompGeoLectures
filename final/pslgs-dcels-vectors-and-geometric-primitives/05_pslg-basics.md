...
- **Previous file in reading order:** [Segment trees as a warm-up search structure](../geometric-objects-notation-and-asymptotic-preliminaries/04_segment-trees.md)
- **Next file in reading order:** [DCEL representation and auxiliary structures](../pslgs-dcels-vectors-and-geometric-primitives/06_dcel.md)
