...
- **Previous file in reading order:** [DCEL representation and auxiliary structures](../pslgs-dcels-vectors-and-geometric-primitives/06_dcel.md)
- **Next file in reading order:** [Orientation tests and signed-area interpretation](../pslgs-dcels-vectors-and-geometric-primitives/08_orientation-and-signed-area.md)
