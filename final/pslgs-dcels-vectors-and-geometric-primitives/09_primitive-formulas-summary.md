...
- **Previous file in reading order:** [Orientation tests and signed-area interpretation](../pslgs-dcels-vectors-and-geometric-primitives/08_orientation-and-signed-area.md)
- **Next file in reading order:** [Search problem taxonomy and inclusion basics](../geometric-search/10_search-taxonomy.md)
