...
- **Previous file in reading order:** [Convex polygon inclusion by wedges](../geometric-search/13_convex-inclusion-by-wedges.md)
- **Next file in reading order:** [Point location by slab decomposition](../geometric-search/15_point-location-slab-method.md)
