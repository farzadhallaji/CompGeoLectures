...
- **Previous file in reading order:** [Grid method](../geometric-search/24_grid-method.md)
- **Next file in reading order:** [k-d tree method](../geometric-search/26_kd-tree-method.md)
