...
- **Previous file in reading order:** [Point location by slab decomposition](../geometric-search/15_point-location-slab-method.md)
- **Next file in reading order:** [Chain method: basics, definitions, and query idea](../geometric-search/17_chain-method-basics-and-query.md)
