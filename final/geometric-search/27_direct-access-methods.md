...
- **Previous file in reading order:** [k-d tree method](../geometric-search/26_kd-tree-method.md)
- **Next file in reading order:** [Range trees](../geometric-search/28_range-trees.md)
