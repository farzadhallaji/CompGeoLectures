...
- **Previous file in reading order:** [Chain method: basics, definitions, and query idea](../geometric-search/17_chain-method-basics-and-query.md)
- **Next file in reading order:** [Chain method: regularization of arbitrary PSLGs](../geometric-search/19_chain-method-regularization.md)
