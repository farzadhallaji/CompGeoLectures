...
- **Previous file in reading order:** [Range trees](../geometric-search/28_range-trees.md)
- **Next file in reading order:** [Convex hull motivation and why the topic matters](../convex-hulls/30_convex-hull-motivation.md)
