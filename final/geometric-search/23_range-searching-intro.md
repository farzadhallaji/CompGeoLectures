...
- **Previous file in reading order:** [Triangle refinement: hierarchy, query, storage, and analysis](../geometric-search/22_triangle-refinement-query-and-analysis.md)
- **Next file in reading order:** [Grid method](../geometric-search/24_grid-method.md)
