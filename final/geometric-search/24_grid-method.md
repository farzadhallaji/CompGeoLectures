...
- **Previous file in reading order:** [Range searching: problem statement and design space](../geometric-search/23_range-searching-intro.md)
- **Next file in reading order:** [Quadtree method](../geometric-search/25_quadtree-method.md)
