...
- **Previous file in reading order:** [Triangle refinement: setup and triangulation](../geometric-search/21_triangle-refinement-setup.md)
- **Next file in reading order:** [Range searching: problem statement and design space](../geometric-search/23_range-searching-intro.md)
