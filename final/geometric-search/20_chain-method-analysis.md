...
- **Previous file in reading order:** [Chain method: regularization of arbitrary PSLGs](../geometric-search/19_chain-method-regularization.md)
- **Next file in reading order:** [Triangle refinement: setup and triangulation](../geometric-search/21_triangle-refinement-setup.md)
