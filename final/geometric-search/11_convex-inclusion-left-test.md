...
- **Previous file in reading order:** [Search problem taxonomy and inclusion basics](../geometric-search/10_search-taxonomy.md)
- **Next file in reading order:** [Simple polygon inclusion by intersection counting](../geometric-search/12_simple-polygon-inclusion-ray-shooting.md)
