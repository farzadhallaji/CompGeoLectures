...
- **Previous file in reading order:** [Quadtree method](../geometric-search/25_quadtree-method.md)
- **Next file in reading order:** [Direct access methods](../geometric-search/27_direct-access-methods.md)
