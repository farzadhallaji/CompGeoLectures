...
- **Previous file in reading order:** [Primitive formulas and summary](../pslgs-dcels-vectors-and-geometric-primitives/09_primitive-formulas-summary.md)
- **Next file in reading order:** [Convex polygon inclusion by left test](../geometric-search/11_convex-inclusion-left-test.md)
