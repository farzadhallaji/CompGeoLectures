...
- **Previous file in reading order:** [Quickhull](../convex-hulls/39_quickhull.md)
- **Next file in reading order:** [Supporting lines from hull union](../convex-hulls/41_supporting-lines.md)
