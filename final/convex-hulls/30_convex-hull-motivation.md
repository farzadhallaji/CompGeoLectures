...
- **Previous file in reading order:** [Range searching summary](../geometric-search/29_range-searching-summary.md)
- **Next file in reading order:** [Convex hull intuition and preliminaries](../convex-hulls/31_convex-hull-intuition.md)
