...
- **Previous file in reading order:** [Dynamic/on-line convex hull insertion: data structure, search, update, and analysis](../convex-hulls/43_dynamic-hull-data-structure.md)
- **Next file in reading order:** [Gift wrapping in higher dimensions: algorithm and adjacent facets](../convex-hulls/45_higher-dimensional-hull-algorithm.md)
