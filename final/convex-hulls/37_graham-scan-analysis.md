...
- **Previous file in reading order:** [Graham’s scan: concept and preparation](../convex-hulls/36_graham-scan-algorithm.md)
- **Next file in reading order:** [Jarvis march (gift wrapping) in 2D](../convex-hulls/38_jarvis-march.md)
