...
- **Previous file in reading order:** [Dynamic/on-line convex hull insertion: problem setting and core idea](../convex-hulls/42_dynamic-hull-core-idea.md)
- **Next file in reading order:** [Gift wrapping in higher dimensions: background and setup](../convex-hulls/44_higher-dimensional-hull-background.md)
