...
- **Previous file in reading order:** [Supporting lines from hull union](../convex-hulls/41_supporting-lines.md)
- **Next file in reading order:** [Dynamic/on-line convex hull insertion: data structure, search, update, and analysis](../convex-hulls/43_dynamic-hull-data-structure.md)
