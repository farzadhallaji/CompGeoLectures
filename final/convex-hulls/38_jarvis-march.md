...
- **Previous file in reading order:** [Graham’s scan: analysis, upper-lower hull view, and summary](../convex-hulls/37_graham-scan-analysis.md)
- **Next file in reading order:** [Quickhull](../convex-hulls/39_quickhull.md)
