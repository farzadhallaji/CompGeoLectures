...
- **Previous file in reading order:** [Polygonal geometry, convexity, planarity, and polyhedra](../geometric-objects-notation-and-asymptotic-preliminaries/02_polygonal-geometry-planarity-and-polyhedra.md)
- **Next file in reading order:** [Segment trees as a warm-up search structure](../geometric-objects-notation-and-asymptotic-preliminaries/04_segment-trees.md)
