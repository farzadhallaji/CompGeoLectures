...
- **Previous file in reading order:** [Computational models and complexity language](../geometric-objects-notation-and-asymptotic-preliminaries/03_models-and-complexity-language.md)
- **Next file in reading order:** [Planar straight-line graphs and face-edge structure](../pslgs-dcels-vectors-and-geometric-primitives/05_pslg-basics.md)
